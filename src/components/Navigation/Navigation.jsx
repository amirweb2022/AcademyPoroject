          ...
          <nav className="flex items-center justify-between">
            <div className="flex justify-center items-center">
              ...
              <div className="hidden md:flex justify-center items-center">
                <ul className="flex justify-cenetr items-center">
                  <div className="ml-5">
                    <NavLink to="/">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  {nav_Link.map((text, index) => (
                    <li className="ml-3" key={index}>
                      <NavLink
                        ...
                        className={(navClass) =>
                          navClass.isActive
                            ? "text-lg text-blue-500 font-bold flex w-full"
                            : "text-lg text-slate-700 font-normal transiton-all duration-150 hover:text-blue-500"
                        }
                      >
    ...
    <React.Fragment>
      ...
      >
        <Tooltip title="Account settings">
          ...
          >
            <Avatar sx={{ width: 36, height: 36 }} src={avataImage}>
              M
            </Avatar>
          </IconButton>
        </Tooltip>
      ...
      >
        ...
        <div className="w-ful px-2 py-1">
          ...
          >
            ...
            <p className="mr-4 font-bold text-sm">حساب کاربری</p>
          </Link>
        </div>
        <div className="w-ful px-2 py-1">
          <Link
          ...
          >
            ...
            <p className="font-bold text-sm">دوره های من</p>
          </Link>
        </div>
        <div className="w-ful px-2 py-1">
          <Link
        ...
        <div className="w-ful px-2 py-1" onClick={clickHandler}>
          <Link className="w-full p-3 flex justify-start items-start text-gray-500 hover:bg-gray-100 rounded-md hover:text-red-500">
            ...
            <p className="font-bold text-sm">خروج</p>
          </Link>
        </div>
      </Menu>
    </React.Fragment>
